...
- 积分兑换（优惠券、商品券）
- 兑换限制显示（每人限兑次数、总兑换数）
- 兑换状态显示（可兑换/已兑换/已兑完/积分不足）

#### 3.3.11 pages/address/ - 地址管理页
**功能说明**：收货地址管理页面
...
#### 3.4.2 utils/api-service.js
**文件说明**：API 服务封装

**主要功能**：
- 各模块 API 接口封装
- 统一的接口调用方式
- 包含：认证、首页、商品、购物车、订单、优惠券、积分、支付等
